...
{
	sUid: "123456",  //用户标识
	startTime: "1559703841917",   	// 开始时间时间戳：2019-05-26	"" 若均为空，则查询全部
	endTime: "1559703841917",  	// 结束时间时间戳：2019-05-27     "" 若均为空，则查询全部
	pageSize: 20,	// 每页显示的条数
	currentPage: 1,	// 当前页数
...
[
	{
		...
		mrecv: "张三", // 收件人
		mcont: "短信内容。。。",	// 短信内容
		mdate: "1559703841917",  	// 发送时间时间戳：2019-09-21 08-50-11
...
```json
{
	...
	mCont: "发送内容。。。",
	sendTime: "1559703841917",	// 发送时间时间戳：2019-09-21 08-50-11--mDate   
}
```
