...
**wsdl.namespace**=**http://webservice.proxy.ibase.southgis.com/**  
...
注：其中，wsdl.url为智臣公司提供的webService地址；wsdl.namespace，wsdl.method，wsdl.parameter为默认即可；wsdl.username和wsdl.password由智臣公司提供；最后两个服务接口地址，也由智臣公司提供，注意区分上传下载地址，别搞混淆。
